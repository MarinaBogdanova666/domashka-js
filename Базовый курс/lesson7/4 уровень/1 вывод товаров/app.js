...
let elemProducts = document.querySelector(".products");
let elemsButton = document.querySelectorAll("button");

elemsButton.forEach(function(button) {
